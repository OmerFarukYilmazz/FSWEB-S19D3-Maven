...
public class AuthenticationService {
    ...
    public Member register(String email, String password){
        Optional<Member> memberOptional = memberRepository.findByEmail(email); // check email if existed.
        ...
        String encodePassword =  passwordEncoder.encode(password); // encode password
